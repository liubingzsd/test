...
double **e1(double **ptr, int row, int column, float sigma) {
...
int test_filter_2d() 
{
	double **arr2 = NULL, **filter = NULL, **arr1 = NULL, **Ix = NULL, **Iy = NULL, **Ixx = NULL, **Ixy = NULL, **Iyy = NULL;
